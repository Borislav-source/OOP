...
class TestRoom(unittest.TestCase):
    ...
    def setUp(self) -> None:
        self.room = Room(family_name='Tsvetkovy', budget=250, members_count=4)
    ...
    def test_room__calculate_expenses(self):
        self.room.appliances = [TV()]
        self.room.calculate_expenses()
        self.assertEqual(45.0, self.room.expenses)
